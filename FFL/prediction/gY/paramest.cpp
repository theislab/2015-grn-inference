...
int main(int argc, char** argv) {
    ...
    inFile.open("/home/icb/andrea.ocone/FFL/prediction/gY/DataBranch_1_3.txt");
    for(int i = 0; i < Ob1; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/FFL/prediction/gY/TimesBranch_1_3.txt");
    for(int i = 0; i < Ob1; i++){
        inFile >> times1[i];
    }
    for(int i = 0; i < Ob1; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/FFL/prediction/gY/Interpolators1.txt");
    for(int i = 0; i < N; i++){
	...
	std::vector<double>                sLik(T,0);    
 	std::string                        fileName = "/home/icb/andrea.ocone/FFL/prediction/gY/Risulta_";
