...
for j = 1:nRealiz
    ...
    for i = 1:T-1
        ...
        a(3,i+1) = a(3,i) + dt*(synthS*(1/(1+(K_d_activation/a(1,i))^n_activation)) - decay*a(3,i)) + sqrt(sigma)*randn;
...
for i = 1:T-1
    ...
    a(3,i+1) = a(3,i) + dt*(synthS*(1/(1+(K_d_activation/a(1,i))^n_activation)) - decay*a(3,i));
...
for i = 1:mT-1
    ...
    a(3,i+1) = a(3,i) + dt*(synthZ*(1/(1+(K_d_activationZ/a(1,i))^n_activationZ)) - decayZ*a(3,i));
