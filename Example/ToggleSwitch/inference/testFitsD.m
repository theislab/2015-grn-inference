...
target = 'geneD';
folder = {'ANDpm';'ANDpp';'ORpm';'ORpp';'Ap';'Cm';'Cp'};

gene      = 4; % gene to simulate
emuInd1   = 1; % emulator 1
emuInd2   = 3; % emulator 2
...
for br = 1:2
    ...
    cd(target)
    if br==1
        Data = importdata('DataBranch_1_4.txt');
        Time = importdata('TimesBranch_1_4.txt');
        Emul = importdata('Interpolators1.txt');
    end
    if br==2
        Data = importdata('DataBranch_2_4.txt');
        Time = importdata('TimesBranch_2_4.txt');
