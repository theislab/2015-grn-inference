...
int main(int argc, char** argv) {
    ...
    const int    geneIndA      = 4;
    const int    emu1IndA      = 1;
    const int    emu2IndA      = 3;
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/DataBranch_1_4.txt");
    for(int i = 0; i < Ob1; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/DataBranch_2_4.txt");
    for(int i = 0; i < Ob2; i++){
        for(int j = 0; j < nReps; j++){
            inFile >> data2A[i][j];
        }
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/TimesBranch_1_4.txt");
    for(int i = 0; i < Ob1; i++){
        inFile >> times1[i];
    }
    for(int i = 0; i < Ob1; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/TimesBranch_2_4.txt");
    for(int i = 0; i < Ob2; i++){
        inFile >> times2[i];
    }
    for(int i = 0; i < Ob2; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/Interpolators1.txt");
    for(int i = 0; i < N; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/Interpolators2.txt");
    for(int i = 0; i < N; i++){
        for(int j = 0; j < ngenes; j++){
            inFile >> emulTotB[i][j];
        }
	...
	std::vector<double>                sLik(T,0);    
 	std::string                        fileName = "/home/icb/andrea.ocone/Toggle/inference/modelSelection/geneD/BayesFactor/ANDpm/Risulta_";
