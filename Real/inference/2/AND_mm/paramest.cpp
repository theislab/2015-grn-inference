...
int main(int argc, char** argv) {
    ...
    inFile.open("/home/icb/andrea.ocone/Real/inference/DataBranch_2.txt");
    for(int i = 0; i < Ob1; i++){
    ...
    inFile.open("/home/icb/andrea.ocone/Real/inference/TimesBranch_2.txt");
    for(int i = 0; i < Ob1; i++){
        inFile >> times1[i];
    }
    for(int i = 0; i < Ob1; i++){
	...
	std::vector<double>                sLik(T,0);    
 	std::string                        fileName = "/home/icb/andrea.ocone/Real/inference/2/AND_mm/Risulta_";
