...
int main(int argc, char** argv) {
    ...
    const int 	 nPar   = 8;          // number parameters
    ...
    // uniform prior
    double priorMax[nPar] = {log(2000), log(50), log(2000), log(30), log(2000), log(30), log(2000), log(30)};
	...
	std::vector<double>                sLik(T,0);    
 	std::string                        fileName = "/home/icb/andrea.ocone/Real/inference/1/ORmp_12_ANDp_3/Risulta_";
    ...
    params[6] = log(randn(150,50));
    params[7] = log(randn(1,0.1));
	...
	for(int iter=1; iter<31; iter++){
	    ...
	    for(int ii=1; ii<T; ii++){
	        ...
	        if((paramsNew[0]<priorMax[0])&(paramsNew[1]<priorMax[1])&(paramsNew[2]<priorMax[2])&(paramsNew[3]<priorMax[3])&(paramsNew[4]<priorMax[4])&(paramsNew[5]<priorMax[5])&(paramsNew[6]<priorMax[6])&(paramsNew[7]<priorMax[7])&(negative<6))
    	    {
