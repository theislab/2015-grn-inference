...
int main(int argc, char** argv) {
	...
	if(argc < 5)
	{
		std::cerr << "input <temperature> <number of temperatures> <gene index> <emulator-1> <emulator-2> <Ob>\n";
       	return EXIT_FAILURE;
    }
    ...
    const int    Ob1    	  = atof(argv[6]);         // number observations
	...
	std::vector<double>                sLik(T,0);    
 	std::string                        fileName = "/home/icb/andrea.ocone/Real/inference/1/ANDmp_13/Risulta_";
